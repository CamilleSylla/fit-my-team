      ...
      <NavSections>
        <NavSection>
          <NavLink to="/" icon={<HomeIcon />}>
            <Link to="/plugins/stripe">Home</Link>
          </NavLink>
        </NavSection>
        <NavSection label="Products">
          <NavLink to="/" icon={<CreateIcon />}>
            <Link to="/plugins/stripe/product/create">Create</Link>
          </NavLink>
          <Link to="/plugins/stripe/product/list">
            <NavLink to="/plugins/stripe/product/list" icon={<ListIcon />}>
              List
            </NavLink>
          </Link>
        </NavSection>
        <NavLink to="/cm" icon={<SettingIcon />}>
          Setting
        </NavLink>
      </NavSections>
    </MainNav>
